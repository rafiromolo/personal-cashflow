<template>
  ...
  >
    <div :class="['py-8 flex', !isExpanded && !isHovered ? 'lg:justify-center' : 'justify-start']">
      <router-link to="/">
        <h1 v-if="isExpanded || isHovered || isMobileOpen" class="text-2xl font-bold">
          Personal Cashflow
        </h1>
        <h1 v-else class="text-2xl font-bold">PC</h1>
      </router-link>
    </div>
    ...
    items: [
      ...
      },
      {
        ...
        subItems: [
          ...
          { name: 'Transfers', path: '/transaction-transfers', pro: false },
        ],
      },
    ],
  },
